...
class MaluCrochesSupabaseUser extends BaseAuthUser {
  MaluCrochesSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> maluCrochesSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = MaluCrochesSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
